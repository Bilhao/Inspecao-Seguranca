...
class ResumoInspecaoSubestacaoPage extends StatelessWidget {
  const ResumoInspecaoSubestacaoPage({super.key});
            ...
            Table(defaultVerticalAlignment: TableCellVerticalAlignment.middle, columnWidths: const <int, TableColumnWidth>{
              ...
              const TableRow(children: [
                ...
                Padding(
                  ...
                  child: Text("Observações", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                ),
              ]),
  ...
  Widget _buildSaveAlertDialog(BuildContext context, SubestacaoProvider provider) {
    return AlertDialog(
      ...
      actions: [
        TextButton(
          ...
          onPressed: () async {
            if (await subestacaotoxlsx(provider: provider, sendEmail: false) && context.mounted) {
  ...
  Widget _buildEmailAlertDialog(BuildContext context, SubestacaoProvider provider) {
      ...
      actions: [
        TextButton(
          ...
          onPressed: () async {
            ...
            bool saved = await subestacaotoxlsx(provider: provider, sendEmail: true, destinatario: emailController.value.text);
