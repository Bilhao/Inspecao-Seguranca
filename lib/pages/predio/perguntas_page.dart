...
class PerguntasPredioPage extends StatefulWidget {
  const PerguntasPredioPage({super.key, required this.id});

  final int id;

  @override
  State<PerguntasPredioPage> createState() => _PerguntasPredioPageState();
}

class _PerguntasPredioPageState extends State<PerguntasPredioPage> {
  @override
