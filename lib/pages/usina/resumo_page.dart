...
class ResumoInspecaoUsinaPage extends StatelessWidget {
  const ResumoInspecaoUsinaPage({super.key});

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<UsinaProvider>(context, listen: false);
  ...
  Widget _buildSaveAlertDialog(BuildContext context, UsinaProvider provider) {
    return AlertDialog(
      ...
      actions: [
        TextButton(
          ...
          onPressed: () async {
            if (await usinatoxlsx(provider: provider, sendEmail: false) && context.mounted) {
  ...
  Widget _buildEmailAlertDialog(BuildContext context, UsinaProvider provider) {
      ...
      actions: [
        TextButton(
          ...
          onPressed: () async {
            ...
            bool saved = await usinatoxlsx(provider: provider, sendEmail: true, destinatario: emailController.value.text);
