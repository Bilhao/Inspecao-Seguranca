...
class PerguntasUsinaPage extends StatefulWidget {
  const PerguntasUsinaPage({super.key, required this.id});

  final int id;

  @override
  State<PerguntasUsinaPage> createState() => _PerguntasUsinaPageState();
}

class _PerguntasUsinaPageState extends State<PerguntasUsinaPage> {
  @override
