...
class InspecaoUsinaPage extends StatefulWidget {
  const InspecaoUsinaPage({super.key});

  @override
  State<InspecaoUsinaPage> createState() => _InspecaoUsinaPageState();
}

class _InspecaoUsinaPageState extends State<InspecaoUsinaPage> {
  @override
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, UsinaProvider provider, child) {
        return Scaffold(
          appBar: AppBar(
            title: const Text('Locais da Usina', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            centerTitle: true,
                        ...
                        child: Column(
                          ...
                          children: [
                            Text.rich(
                              TextSpan(
                                children: [
                                  TextSpan(text: provider.usina, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                            Text.rich(
                        ...
                        for (int i = 0; i < provider.itensId.length; i++)
                          Container(
                            ...
                            child: FilledButton.tonal(
                              onPressed: () => Navigator.pushNamed(context, "/perguntas-usina", arguments: {"id": i}),
                              style: ButtonStyle(
          ...
          floatingActionButton: MediaQuery.of(context).viewInsets.bottom != 0.0
            ...
            : FloatingActionButton.extended(
              onPressed: () {
                Navigator.pushNamed(context, "/inspecao-usina-resumo");
              },
              backgroundColor: Theme.of(context).colorScheme.primary,
              heroTag: "unique_tag_usina",
