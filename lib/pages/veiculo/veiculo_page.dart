  ...
  Widget build(BuildContext context) {
    return Consumer<VeiculoProvider>(
        builder: (context, provider, child) {
          return Scaffold(
            appBar: AppBar(
              title: const Text('Inspeção de Veículos', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              centerTitle: true,
            ...
            body: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    const Text("Escolha o Prefixo do Veículo: ", style: TextStyle(fontSize: 16)),
                    const Divider(height: 15, color: Colors.transparent),
                    DropdownMenu(
                      width: double.maxFinite,
                      initialSelection: provider.veiculo,
                      onSelected: (value) {
                        setState(() {
                          dropMenuerrorText = null;
                        });
                        provider.veiculo = value.toString();
                      },
                      ...
                      dropdownMenuEntries: veiculos
                          .map((veiculo) => DropdownMenuEntry(value: veiculo, label: veiculo))
                          .toList(),
                    ),
            ...
            floatingActionButton: MediaQuery.of(context).viewInsets.bottom != 0.0
              ...
              onPressed: () {
                if (provider.veiculo == "" || provider.inspetor1 == "") {
                  ...
                  Navigator.pushNamed(context, "/inspecao-veiculo", arguments: {"id": 0});
                }
              },
              backgroundColor: Theme.of(context).colorScheme.primary,
              heroTag: "unique_tag",
