...
class PerguntasVeiculoPage extends StatefulWidget {
  const PerguntasVeiculoPage({super.key, required this.id});

  final int id;

  @override
  State<PerguntasVeiculoPage> createState() => _PerguntasVeiculoPageState();
}

class _PerguntasVeiculoPageState extends State<PerguntasVeiculoPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("$itemId. $item", style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              widget.id == 10
                  ? Center(child: Image(image: const AssetImage("assets/images/veiculo/veiculo-imagem-superior-1-5.png")))
                  : const Divider(height: 0, color: Colors.transparent),
              widget.id == 11
                  ? Center(child: Image(image: const AssetImage("assets/images/veiculo/veiculo-imagem-frente-6-10.png")))
                  : const Divider(height: 0, color: Colors.transparent),
              widget.id == 12
                  ? Center(child: Image(image: const AssetImage("assets/images/veiculo/veiculo-imagem-traseira-11-14.png")))
                  : const Divider(height: 0, color: Colors.transparent),
              widget.id == 13
                  ? Center(child: Image(image: const AssetImage("assets/images/veiculo/veiculo-imagem-direita-15-23.png")))
                  : const Divider(height: 0, color: Colors.transparent),
              widget.id == 14
                  ? Center(child: Image(image: const AssetImage("assets/images/veiculo/veiculo-imagem-esquerda-24-32.png")))
                  : const Divider(height: 0, color: Colors.transparent),
              [10, 11, 12, 13, 14].contains(widget.id)
