...
class InspecaoVeiculoPage extends StatefulWidget {
  const InspecaoVeiculoPage({super.key});

  @override
  State<InspecaoVeiculoPage> createState() => _InspecaoVeiculoPageState();
}

class _InspecaoVeiculoPageState extends State<InspecaoVeiculoPage> {
  @override
  Widget build(BuildContext context) {
    return Consumer(
        builder: (context, VeiculoProvider provider, child) {
          return Scaffold(
              appBar: AppBar(
                title: const Text('Partes do Veículo', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                centerTitle: true,
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: const Text("Selecione um ítem para inspeção: ", style: TextStyle(fontSize: 16)),
                    )
                  ),
                  Expanded(
                    child: Padding(
                            ...
                            for (int i = 0; i < provider.itensId.length; i++)
                              Container(
                                ...
                                child: FilledButton.tonal(
                                  onPressed: () => Navigator.pushNamed(context, "/perguntas-veiculo", arguments: {"id": i}),
                                  style: ButtonStyle(
              ...
              floatingActionButton: MediaQuery.of(context).viewInsets.bottom != 0.0
                ...
                onPressed: () {
                  Navigator.pushNamed(context, "/inspecao-veiculo-resumo");
                },
                backgroundColor: Theme.of(context).colorScheme.primary,
                heroTag: "unique_tag_veiculo",
