...
void main() async {
  ...
  try {
    ...
    debugPrint('Arquivo .env não foi encontrado: $e');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      ...
      builder: (context, child) => MaterialApp(
        ...
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFFEC6500), primary: const Color(0xFFEC6500), brightness: Brightness.light),
          useMaterial3: true,
        ),
